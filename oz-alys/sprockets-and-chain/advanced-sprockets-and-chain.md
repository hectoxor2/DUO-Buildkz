...
Maximum CDC=Total Solution Width−Clearance Radius 1−Clearance Radius 2\text{Maximum CDC} = \text{Total Solution Width} - \text{Clearance Radius 1}-\text{Clearance Radius 2}

Total Solution Width=5inchesClearance Radius 1 =15Tchain clearance diameter(A)=1.45 inchesClearance Radius 2=20Tchain clearance diameter(A)=1.85 inches\text{Total Solution Width} = 5 \text {inches}\newline\text{Clearance Radius 1}\\,=15T\_{chain\\, clearance\\, diameter(A)} = 1.45\\,\text{inches}\newline\text{Clearance Radius 2} =20T\_{chain\\, clearance\\, diameter(A)} = 1.85\\,\text{inches}

Maximum CDC Available=5−1.452−1.852Maximum CDC Available=3.35inches\text{Maximum CDC Available} = 5 - \frac{1.45}{2} - \frac{1.85}{2}\newline\text{Maximum CDC Available} = 3.35 \text{inches}
...
[chain length in pitches equation](broken-reference)

.

L=\[2(3.35)0.25]+\[20+152]+\[0.25(20−152π)23.35]L=\[6.70.25]+\[352]+\[0.25(52π)23.35]L=26.8+17.5+\[0.25(0.796)23.35]L=44.3+\[0.25×0.6343.35]L=44.3+0.15853.35L=44.347L =\left\[ \frac{2(3.35)}{0.25} \right]+\left\[ \frac{20+15}{2}\right] + \left\[\frac{0.25(\frac{20 -15}{2\pi})^2}{3.35}\right]\\\L = \left\[\frac{6.7}{0.25}\right] +\left\[\frac{35}{2}\right]+ \left\[\frac{0.25(\frac{5}{2\pi})^2}{3.35}\right]\\\L = 26.8 + 17.5 + \left\[\frac{0.25(0.796)^2}{3.35}\right]\newline L = 44.3 + \left\[\frac{0.25\times 0.634}{3.35} \right]\\\L = 44.3 + \frac{0.1585}{3.35}\\\ L = 44.347
